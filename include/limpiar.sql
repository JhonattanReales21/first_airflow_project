...
CREATE OR REPLACE TABLE {{params.database}}.{{params.schema}}.transformed_weather_data (
...
INSERT INTO {{params.database}}.{{params.schema}}.transformed_weather_data
SELECT DISTINCT
    DESCIEL,
...
FROM {{params.database}}.{{params.schema}}.CONAGUA_WEATHER_RAW;